...
- GitHub Release：[`v0.1.48`](https://github.com/linsk27/proof-pr/releases/tag/v0.1.48)
- npm：[`proof-pr@0.1.48`](https://www.npmjs.com/package/proof-pr)
- GitHub Action：`linsk27/proof-pr@v0.1.48`
...
- **发布链路已验证**：npm Trusted Publishing 已绑定 `linsk27/proof-pr` + `release.yml`，`v0.1.21` 到 `v0.1.48` 已通过 GitHub OIDC 自动发布到 npm。
...
本地 `check` 通常没有 PR 标题和描述上下文，报告会明确提示这一点；打开 PR 后，ProofPR 会结合 PR 标题和描述重新评估证据。
