...
- GitHub Release：[`v0.1.32`](https://github.com/linsk27/proof-pr/releases/tag/v0.1.32)
- npm：[`proof-pr@0.1.32`](https://www.npmjs.com/package/proof-pr)
- GitHub Action：`linsk27/proof-pr@v0.1.32`
...
- **发布链路已验证**：npm Trusted Publishing 已绑定 `linsk27/proof-pr` + `release.yml`，`v0.1.21` 到 `v0.1.32` 已通过 GitHub OIDC 自动发布到 npm。
...
如果你习惯先看帮助，`npx proof-pr@latest --help` 也会在底部给出三条常用复制命令。
